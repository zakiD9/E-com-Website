  ...
  "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=1600",
    ...
    return(
        <div className="flex my-4 gap-5">
            <HeroSlider activeIndex={activeIndex}  images={slider1} className="w-[650px] h-[325px]"/>
            <HeroSlider activeIndex={activeIndex}  images={slider2} className="w-[650px] h-[325px]"/>
        </div>
    )
}